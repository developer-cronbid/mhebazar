          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
            <div className="lg:col-span-2">
                ...
                <div>
                  ...
                  <div className="flex flex-col md:flex-row">
                    <a
                      ...
                      className="text-sm text-gray-600 pr-2 md:border-r-2 hover:text-blue-700 transition"
                    >
                      sales.1@mhebazar.com
                    </a>
                    <a
                      href="mailto:sales.2@mhebazar.com"
                      className="text-sm text-gray-600 pl-2 hover:text-blue-700 transition"
                    >
              ...
              <div className="flex items-center gap-4 mt-8">
                <Link
                  href="https://www.linkedin.com/company/mhe-bazar/"
                  target="_blank"
                  aria-label="LinkedIn"
                >
                  <Image
                    ...
                    width={30}
                    height={30}
                    className="filter hover:grayscale-0 hover:scale-105 transition-all duration-300"
                  />
                </Link>
                <Link
                  href="https://www.instagram.com/mhebazar.in/"
                  target="_blank"
                ...
                <Link
                  href="https://www.facebook.com/mhebazar.in/"
                  target="_blank"
                  aria-label="Facebook"
                >
                  <Image
                ...
                <Link
                  href="https://twitter.com/Greentech_MH"
                  target="_blank"
                ...
                <Link
                  href="https://www.youtube.com/@mhebazar"
                  target="_blank"
                  aria-label="YouTube"
                >
                  <Image
                ...
                <Link
                  href="https://in.pinterest.com/greentechindiamh/"
                  target="_blank"
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link
                    ...
                    className="text-gray-600 underline hover:text-blue-700 transition"
                  >
                    Terms & Conditions
                  </Link>
                </li>
