...
// Review data ordered by the user's request: Perumal, Xavier, then Rajappa
const reviews = [
  // Perumal - ID 4
  {
    id: 4,
    ...
    avatar: "/css/newassets/imgs/page/testimonials/e-forklifters-pvt-ltd-mr-perumal.webp",
    fallback: "PN",
    rating: 5,
  ...
  // Xavier - ID 12
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/engineering-group-mr-benzie-xavier.webp",
    fallback: "PN",
    rating: 5,
    category: "MHE Equipment",
    date: "2023-12-05",
  ...
  // Rajappa - ID 9
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/rial-handling-pvt-ltd-mr-rajappa.webp",
    fallback: "PN",
    rating: 5,
  ...
  // Remaining reviews in their original order
  {
    id: 1,
    name: "Mr. Manohari Lal",
    role: "M/s. A.M. Enterprises",
    avatar: "/css/newassets/imgs/page/testimonials/photo/M_s. AM Enterprises, Mr. Manohari Lal.png",
    fallback: "ML",
    rating: 5,
    category: "MHE Equipment",
    date: "2023-01-15",
  ...
  },
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/photo/M_s. Asmita Engineering, Mr. Nitish Hirve.png",
    fallback: "NH",
    rating: 5,
  ...
  },
  {
    ...
    role: "M/s. R S Global",
    avatar: "/css/newassets/imgs/page/testimonials/photo/M_s. R S Global, Mr. Pathan Nawaz.png",
    fallback: "PN",
    rating: 5,
    category: "Battery Technology",
    date: "2023-03-10",
  ...
  },
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/ting-engineers-mr-prasad-dhaniwale.webp",
    fallback: "PN",
    rating: 5,
    category: "Battery Technology",
    date: "2023-05-18",
  ...
  },
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/s-prt-enterprises-mr-ram-thanash.webp",
    fallback: "PN",
    rating: 4,
    category: "Electric Equipment",
    date: "2023-06-01",
  ...
  },
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/r-mills-pvt-ltd-mr-bharat-ganesh.webp",
    fallback: "PN",
    rating: 5,
    category: "MHE Equipment",
    date: "2023-07-08",
  ...
  },
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/mbey-developers-mr-manoj-shekhawat.webp",
    fallback: "PN",
    rating: 5,
    category: "Battery Technology",
    date: "2023-08-14",
  ...
  },
  {
    ...
    avatar: "/css/newassets/imgs/page/testimonials/a-traction-pvt-ltd-mrs-divya-roy.webp",
    fallback: "PN",
    rating: 5,
    category: "MHE Equipment",
    date: "2023-10-15",
  ...
  },
  {
    ...
    role: "MAC SPARES",
    avatar: "/css/newassets/imgs/page/testimonials/mr-jayanta-dutta-mac-spares.webp",
    fallback: "PN",
    rating: 5,
    category: "Battery Technology",
    date: "2023-11-20",
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center sm:mb-12 flex items-center justify-between">
          ...
          <Link href="/testimonials">
            <span className="text-[#42a856] font-medium cursor-pointer text-sm hover:underline">
              View More
            </span>
          </Link>
        </div>
