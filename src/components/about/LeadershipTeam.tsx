...
import { FaLinkedin } from 'react-icons/fa'; // Added FaLinkedin icon for better social links
...
// Reordered team members as per the request
              ...
              >
                ...
                <div className="flex flex-col flex-grow p-4 text-center">
                  ...
                  {member.linkedin && (
                    ...
                    >
                      <FaLinkedin className="mx-auto" size={24} />
                    </a>
                  )}
                </div>
              </div>
