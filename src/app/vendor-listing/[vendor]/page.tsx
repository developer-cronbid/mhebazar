...
      // MODIFICATION 1: Set the default sort to trigger the updated_at sorting
      sortBy: searchParams.get("sort_by") || "updated_desc",
...
        
        // MODIFICATION 2: Update the sorting logic to map the new default
        if (sortBy && sortBy !== "relevance") {
          const sortParam = 
            sortBy === "price_asc" ? "price" : 
            sortBy === "price_desc" ? "-price" : 
            // Map the new default 'updated_desc' to the correct API param
            sortBy === "updated_desc" ? "-updated_at" : 
            "-created_at"; // Fallback remains for other unknown sort_by values
...
    const newSearchParams = new URLSearchParams(searchParams.toString());
    newSearchParams.set("page", "1");
    // Note: 'updated_desc' will be set if the user explicitly selects "Last Updated"
